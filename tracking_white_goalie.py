...
hsvBg = cv2.cvtColor(firstFrame, cv2.COLOR_BGR2HSV)
...
#lower_white = np.array([35,30,170])
##upper_white = np.array([45,40,190])
#lower_white = np.array([30, 10, 200])
#upper_white = np.array([40,30,255])
